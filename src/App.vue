...
export default {
  ...
  setup() {
    ...
    const getUserAvatar = () => {
      ...
      if (!authStore.currentUser) return 'https://ui-avatars.com/api/?name=User&background=007bff&color=fff'
      return `https://ui-avatars.com/api/?name=${encodeURIComponent(authStore.currentUser.username)}&background=007bff&color=fff`
    }
